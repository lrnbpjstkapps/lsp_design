		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<input name="<?php echo $form_name[115]; ?>" value="<?php echo $$form_name[115]; ?>" class="form-control" type="text">
				...
				<div class="form-group">
					...
					<input name="<?php echo $form_name[116]; ?>" value="<?php echo $$form_name[116]; ?>" class="form-control" type="text">
					<span class="help-block"></span>
				</div>	
				...
				<div class="form-group">
					...
					<input name="<?php echo $form_name[119]; ?>" value="<?php echo $$form_name[119]; ?>" class="form-control" type="text">
					<span class="help-block"></span>
				</div>	
				...
				<div class="form-group">
					...
					<textarea name="<?php echo $form_name[120]; ?>" class="form-control" rows="3" style="resize:none"><?php echo $$form_name[120]; ?></textarea>
					<span class="help-block"></span>
				</div>					
			</div>
			...
			<div class = "col-md-6">		
				...
				<div class="form-group">
					...
					<input name="<?php echo $form_name[121]; ?>" value="<?php echo $$form_name[121]; ?>" class="form-control" type="number">
					<span class="help-block"></span>
				</div>	
				...
				<div class="form-group">
					...
					<input name="<?php echo $form_name[122]; ?>" value="<?php echo $$form_name[122]; ?>" class="form-control" type="number">
					<span class="help-block"></span>
				</div>	
				...
				<div class="form-group">
					<label> HP </label>
					<input name="<?php echo $form_name[123]; ?>" value="<?php echo $$form_name[123]; ?>" class="form-control" type="number">
					<span class="help-block"></span>
				</div>	
				...
				<div class="form-group">
					<label> E-mail </label>
					<input name="<?php echo $form_name[124]; ?>" value="<?php echo $$form_name[124]; ?>" class="form-control" type="email">
					<span class="help-block"></span>
				</div>
				...
				<div class="form-group">
					...
					<input name="<?php echo $form_name[125]; ?>" value="<?php echo $$form_name[125]; ?>" class="form-control" type="text">
					<span class="help-block"></span>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<input name="<?php echo $form_name[126]; ?>" value="<?php echo $$form_name[126]; ?>" class="form-control" type="text">
					<span class="help-block"></span>
				</div>	
				...
				<div class="form-group">
					<label> Jabatan </label>
					<input name="<?php echo $form_name[127]; ?>" value="<?php echo $$form_name[127]; ?>" class="form-control" type="text">
					<span class="help-block"></span>
				</div>						
				...
				<div class="form-group">
					...
					<textarea name="<?php echo $form_name[128]; ?>" class="form-control" rows="5" style="resize:none"><?php echo $$form_name[128]; ?></textarea>
					<span class="help-block"></span>
				</div>	
			</div>
			...
			<div class = "col-md-6">
				...
				<div class="form-group">
					...
					<input name="<?php echo $form_name[129]; ?>" value="<?php echo $$form_name[129]; ?>" class="form-control" type="number">
					<span class="help-block"></span>
				</div>
				...
				<div class="form-group">
					...
					<input name="<?php echo $form_name[130]; ?>" value="<?php echo $$form_name[130]; ?>" class="form-control" type="number">
					<span class="help-block"></span>
				</div>	
				...
				<div class="form-group">
					<label> Fax </label>
					<input name="<?php echo $form_name[131]; ?>" value="<?php echo $$form_name[131]; ?>" class="form-control" type="number">
					<span class="help-block"></span>
				</div>
				...
				<div class="form-group">
					<label> E-mail </label>
					<input name="<?php echo $form_name[132]; ?>" value="<?php echo $$form_name[132]; ?>" class="form-control" type="email">
					<span class="help-block"></span>
				</div>
			</div>
		</div>
