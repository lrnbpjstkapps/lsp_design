<script type = "text/javascript">
	...
	function modal_tambah(){
		...
		$('#id_modal_form_pengelola_user').modal('show');
	}
	...
	//View modal 'Jenis Akun'
	function modal_jenis_akun(uuid, param1, param2){			
		tabel_jenis_akun = $('#id_tabel_jenis_akun').DataTable({ 		
			"processing"		: true, 
			"serverSide"		: true,
			"searching"			: false,
			"paging"			: false,
