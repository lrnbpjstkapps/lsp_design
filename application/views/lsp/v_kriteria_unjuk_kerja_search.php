	...
	<div class="box">
		<div class="box-header with-border">
		  <h3 class="box-title"> <?php echo $menu_title[103]; ?> </h3> 
			<form id="<?php echo $form_id[126]; ?>" class="form-horizontal">
				<div class="modal-body form">                 
					<div class="form-body">	
						...
						<div class="form-group">
							<label class="control-label col-md-2"> <?php echo $form_label[118]; ?> </label>
							<div class="col-md-6">
			...
			<button type="button" class="btn bg-navy pull-right" onclick="findDt()" id="<?php echo $form_id[135]; ?>"> <?php echo $form_button[104]; ?> </button>
		</div>
	</div>	
</div>
