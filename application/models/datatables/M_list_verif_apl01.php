<?php
	class m_list_verif_apl01 extends CI_Model{
		...
		var $order			= array(
			'adm.DTM_CRT' => 'DESC',
			'apl01.NAMA_LENGKAP' => 'ASC',
			'skema.NAMA_SKEMA' => 'ASC'
			); 
		...
		public function _get_datatables_query(){
			$this->db->select('adm.UUID_ADM, adm.NO_ASESMEN, apl01.NAMA_LENGKAP, skema.NAMA_SKEMA, apl01.TUJUAN_ASESMEN, adm.DTM_CRT, sa.KETERANGAN');
